...
# pagedown::chrome_print("file:///Users/yenchiehliao/Dropbox/Electoral-Incentives-and-Porks/slides/slides.html#1", verbose = FALSE)
...
--
 ...
 2. Does the switch of electoral system from the SNTV to the SMDs reduce legislators' incentives to cultivate a personal reputation by paying less attention to distributive (pork barrel) policies?
...
- Given this the SNTV system, candidates were competing with competitors from not only opponent parties, but the same party as well. As results, candidates were incentivized to attract votes by giving out more distributive benefits to their own constituency, rather than nation-wide.
...
### Labeld Pork-barrel Legislation

- They have created .hi-grey[hand-labelled legislation] by reading the purpose of statute, devoted either to promoting the pork-barrel project (earmarked projects) in a district or cultivating favored specific population groups by providing subsidies such as agriculture allowance to the farmers ( Luor and Hsieh 2008; Luor and Liao 2009; Luor and Chan 2012).
...
- For exploration of parliarmentary questions, I have web scraped the parliamentary questions and the speeches from The Website of Taiwan Legislative Yuan from 1994 to 2020, including categories of information with regards to the topic, keywords and the type.
...
- In this paper, I aim to incorporate this application to classify the parliamentary questions and evaluate the hypothesis by looking at how electoral reform reduces legislator’s incentive to deliver pork barrel projects. 
...
- In next step, I plan to conduct an in-depth text analysis to compare the variation of topic categories across time and evaluate pork barrel programs in the context of Taiwan politics.
...
### Data
.smaller[[Non-Pork Featured Questions ](#sampled-non-pork)] | .smaller[[Pork Featured Questions](#sampled-pork)] | .smaller[[Why CNN Not RNN](#cnn-rnn)]
...
- CNN learns to identify patterns across space and RNN is trained to learn the pattern across time. 

- The labeled trained data is classified by multiple combination of salient text features such as 軍公教 (military, teachers, public servant, farmer), 補助款 (grant and subsidy).

- Fixed format and standard written style in official document 
